...
<div class="row g-3">
    <div class="col-md-6">
        ...
        <select name="standard_section_id" id="standard_section_id"
            class="form-control @error('standard_section_id') is-invalid @enderror" required>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <span class="input-group-text bg-light text-dark fs-5">
                <i id="icon-preview" class="{{ old('icon', $standard->icon ?? 'fa-light fa-notes-medical') }}">
                </i>
            </span>
        ...
        <small class="d-block text-muted mt-1">
            ...
            (e.g. <code>fa-light fa-notes-medical</code>).
        </small>
    ...
    <div class="form-group">
        ...
        <input type="text" name="abbr" id="abbr" class="form-control @error('abbr') is-invalid @enderror"
            value="{{ old('abbr', $standard->abbr ?? '') }}"
            placeholder="Example: NFPA 99" required>
    ...
    <div class="form-group">
        ...
        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror"
            value="{{ old('title', $standard->title ?? '') }}"
            placeholder="Example: Health Care Facilities Code" required>
    ...
    <div class="form-row">
        ...
        <div class="form-group">
            ...
            <small class="text-muted">
                Enable this option to display the standard on the website.
            </small>
    ...
    <div class="card-footer bg-white py-3 text-end">
        ...
        <a href="{{ route('admin.standards.index') }}" class="btn btn-light me-2">
