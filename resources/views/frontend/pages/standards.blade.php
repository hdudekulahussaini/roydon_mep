    ...
    <main>
        ...
        <section class="std-hero">
            <div class="container">
                ...
                <p class="std-hero-subtitle">We engineer to the standards that govern hospital operation in India and
                    internationally — not as a checkbox, but as a baseline for every design decision.</p>
            </div>
        </section>
