...
@section('content')
    ...
    <main>
        ...
        <section class="pl-50 pr-50 ">
            <div class="breadcrumb-area d-flex justify-content-center align-items-center" style="background-image: linear-gradient(rgba(15, 32, 68, 0.7), rgba(15, 32, 68, 0.7)), url({{ asset('assets/img/bg/hvac_service.webp') }}); background-size: cover; background-position: center; border-radius: 15px; margin-top: 20px;">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-lg-12">
                            <div class="breadcrumb-wrap text-center">
                                <div class="breadcrumb-title">
                                    <h2 style="color: #ffffff; font-size: 48px; font-weight: 700; text-transform: capitalize; margin-bottom: 15px;">Hospital HVAC Systems</h2>
                                    <div class="breadcrumb-wrap">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb justify-content-center">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page" style="color: #0E9B9B; font-weight: 700;">Hospital HVAC</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 order-2">
                        <div class="service-detail pl-30 pr-20">
                            <div class="content-box">
                                ...
                                <h2 style="color: #0F2044; font-size: 38px; font-weight: 700; margin-bottom: 25px; line-height: 1.2;"> Advanced Hospital HVAC Systems </h2>
                                <p style="color: #4B5F70; font-size: 16px; line-height: 1.8; margin-bottom: 35px;">
                                    We design, install, and commission advanced HVAC systems strictly tailored to healthcare environments. Our expertise ensures precise temperature control, optimal humidity, and critical air filtration to meet <strong>ASHRAE 170 and NABH standards</strong>. From operation theatres to isolation wards, we deliver zero-defect environments that safeguard patient health and facility compliance.
                                </p>
                                    ...
                                    <div class="row">
                                        <div class="image-column col-xl-6 col-lg-12 col-md-12 mb-30">
                                            <figure class="image img-custom-anim-left wow fadeInLeft" data-delay=".1s" style="border-radius: 12px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.08); margin: 0;">
                                                <img src="{{ asset('assets/img/bg/hvac_service.webp') }}" alt="Hospital HVAC Contractors Hyderabad by Roydon MEP" style="width: 100%; height: 280px; object-fit: cover; transition: transform 0.5s;">
                                            </figure>
                                        </div>
                                        <div class="text-column col-xl-6 col-lg-12 col-md-12 mb-30">
                                            <figure class="image img-custom-anim-right wow fadeInRight" data-delay=".2s" style="border-radius: 12px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.08); margin: 0;">
                                                <img src="{{ asset('assets/img/specialisation/clean_room_hero.webp') }}" alt="Neelima Hospitals - Healthcare Project Execution by Roydon MEP" style="width: 100%; height: 280px; object-fit: cover; transition: transform 0.5s;">
                                            </figure>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-40">
                                    <div class="col-lg-6 col-md-6">
                                        <div style="background: #fff; border: 1px solid #D5E5E5; padding: 25px; border-radius: 10px; margin-bottom: 20px; transition: all 0.3s; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%;">
                                            <div style="width: 50px; height: 50px; background: #E0F4F4; color: #0E9B9B; font-size: 24px; display: flex; align-items: center; justify-content: center; border-radius: 8px; margin-bottom: 15px;"><i class="fa-light fa-fan"></i></div>
                                            <h4 style="color: #0F2044; font-size: 18px; font-weight: 700; margin-bottom: 10px;">Modular OT Laminar Airflow</h4>
                                            <p style="color: #4B5F70; font-size: 14px; line-height: 1.7; margin: 0;">Complete HEPA H14 filtration setups ensuring ultra-clean surgical environments.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div style="background: #fff; border: 1px solid #D5E5E5; padding: 25px; border-radius: 10px; margin-bottom: 20px; transition: all 0.3s; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%;">
                                            <div style="width: 50px; height: 50px; background: #E0F4F4; color: #0E9B9B; font-size: 24px; display: flex; align-items: center; justify-content: center; border-radius: 8px; margin-bottom: 15px;"><i class="fa-light fa-lungs-virus"></i></div>
                                            <h4 style="color: #0F2044; font-size: 18px; font-weight: 700; margin-bottom: 10px;">ICU Pressure Cascades</h4>
                                            <p style="color: #4B5F70; font-size: 14px; line-height: 1.7; margin: 0;">Positive and negative pressure room designs for infection control and patient isolation.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div style="background: #fff; border: 1px solid #D5E5E5; padding: 25px; border-radius: 10px; margin-bottom: 20px; transition: all 0.3s; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%;">
                                            <div style="width: 50px; height: 50px; background: #E0F4F4; color: #0E9B9B; font-size: 24px; display: flex; align-items: center; justify-content: center; border-radius: 8px; margin-bottom: 15px;"><i class="fa-light fa-snowflake"></i></div>
                                            <h4 style="color: #0F2044; font-size: 18px; font-weight: 700; margin-bottom: 10px;">AHU & Chiller Installations</h4>
                                            <p style="color: #4B5F70; font-size: 14px; line-height: 1.7; margin: 0;">Energy-efficient chilled water systems and dedicated DX units tailored to healthcare loads.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div style="background: #fff; border: 1px solid #D5E5E5; padding: 25px; border-radius: 10px; margin-bottom: 20px; transition: all 0.3s; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%;">
                                            <div style="width: 50px; height: 50px; background: #E0F4F4; color: #0E9B9B; font-size: 24px; display: flex; align-items: center; justify-content: center; border-radius: 8px; margin-bottom: 15px;"><i class="fa-light fa-clipboard-check"></i></div>
                                            <h4 style="color: #0F2044; font-size: 18px; font-weight: 700; margin-bottom: 10px;">Validation & Commissioning</h4>
                                            <p style="color: #4B5F70; font-size: 14px; line-height: 1.7; margin: 0;">Rigorous testing including DOP tests, particle counts, and air balancing reports for audits.</p>
                                        </div>
                                    </div>
                                </div>
