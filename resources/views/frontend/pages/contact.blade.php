    ...
    <main>
        ...
        <section class="contact-hero">
            <div class="container">
                ...
                <p class="contact-hero-subtitle">Fill in the form and we will respond within one business day with a preliminary approach, indicative programme and commercial framework.</p>
            </div>
        </section>
                            ...
                            <form action="#" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="N. Sreedhar Reddy" required>
                                    </div>
                                    <div class="col-md-6 form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="name@hospital.com" required>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="form-label">Phone / WhatsApp *</label>
                                        <input type="tel" class="form-control" placeholder="+91 9XXXXXXXXX" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Hyderabad, Bengaluru, etc." required>
                                    </div>
                                    <div class="col-md-6 form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select class="form-select">
                                            <option value="">— Select —</option>
                                            <option value="New Build / Greenfield">New Build / Greenfield</option>
                                            <option value="Renovation / Brownfield">Renovation / Brownfield</option>
                                            <option value="Expansion">Expansion</option>
                                            <option value="NABH Upgradation">NABH Upgradation</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder="Tell us about the scope — clinical areas required (OT, ICU, NICU, clean room, MGPS, etc.), floor area if known, standards required (NABH, NFPA, ASHRAE), and anything else that will help us respond precisely."></textarea>
                                </div>
                        ...
                        <div class="contact-info-box wow fadeInRight" data-wow-delay="0.2s">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <a href="tel:+917330756745">+91-73307 56745</a>
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <p class="help-text">N Square, Hitec City, Plot 34B, Hyderabad – 500081</p>
                                </div>
                            </div>
