...
@section('content')
    ...
    <main>
        ...
        <section class="pl-50 pr-50 ">
            <div class="breadcrumb-area d-flex justify-content-center align-items-center" style="background-image: linear-gradient(rgba(15, 32, 68, 0.7), rgba(15, 32, 68, 0.7)), url({{ asset('assets/img/bg/electrical_service.webp') }}); background-size: cover; background-position: center; border-radius: 15px; margin-top: 20px;">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-lg-12">
                            <div class="breadcrumb-wrap text-center">
                                <div class="breadcrumb-title">
                                    <h2 style="color: #ffffff; font-size: 48px; font-weight: 700; text-transform: capitalize; margin-bottom: 15px;">Hospital Electrical Systems</h2>
                                    <div class="breadcrumb-wrap">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb justify-content-center">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page" style="color: #0E9B9B; font-weight: 700;">Hospital Electrical</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 order-2">
                        <div class="service-detail pl-30 pr-20">
                            <div class="content-box">
                                ...
                                <h2 style="color: #0F2044; font-size: 38px; font-weight: 700; margin-bottom: 25px; line-height: 1.2;"> Advanced Hospital Electrical Systems </h2>
                                <p style="color: #4B5F70; font-size: 16px; line-height: 1.8; margin-bottom: 35px;">
                                    Robust and uninterrupted electrical systems designed exclusively for hospitals. Our expertise covers HT/LT distribution, UPS systems, DG sets, and specialized isolation transformers for OTs and ICUs.
                                </p>
                                    ...
                                    <div class="row">
                                        <div class="image-column col-xl-6 col-lg-12 col-md-12 mb-30">
                                            <figure class="image img-custom-anim-left wow fadeInLeft" data-delay=".1s" style="border-radius: 12px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.08); margin: 0;">
                                                <img src="{{ asset('assets/img/bg/electrical_service.webp') }}" alt="Hospital Electrical Engineering Services and Turnkey Solutions" style="width: 100%; height: 280px; object-fit: cover; transition: transform 0.5s;">
                                            </figure>
                                        </div>
                                        <div class="text-column col-xl-6 col-lg-12 col-md-12 mb-30">
                                            <figure class="image img-custom-anim-right wow fadeInRight" data-delay=".2s" style="border-radius: 12px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.08); margin: 0;">
                                                <img src="{{ asset('assets/img/specialisation/cath_lab_hero.webp') }}" alt="Landmark Hospital - EPC Contractors South India" style="width: 100%; height: 280px; object-fit: cover; transition: transform 0.5s;">
                                            </figure>
                                        </div>
                                    </div>
                                </div>

                                <h3 style="color: #0F2044; font-size: 28px; font-weight: 700; margin-bottom: 25px;">Key Offerings in Healthcare Electrical</h3>
                                ...
                                <div class="row mb-40">
                                    <div class="col-lg-6 col-md-6">
                                        <div style="background: #fff; border: 1px solid #D5E5E5; padding: 25px; border-radius: 10px; margin-bottom: 20px; transition: all 0.3s; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%;">
                                            <div style="width: 50px; height: 50px; background: #E0F4F4; color: #0E9B9B; font-size: 24px; display: flex; align-items: center; justify-content: center; border-radius: 8px; margin-bottom: 15px;"><i class="fa-light fa-bolt"></i></div>
                                            <h4 style="color: #0F2044; font-size: 18px; font-weight: 700; margin-bottom: 10px;">HT/LT Distribution</h4>
                                            <p style="color: #4B5F70; font-size: 14px; line-height: 1.7; margin: 0;">Reliable high and low tension electrical network designs for heavy medical loads.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div style="background: #fff; border: 1px solid #D5E5E5; padding: 25px; border-radius: 10px; margin-bottom: 20px; transition: all 0.3s; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%;">
                                            <div style="width: 50px; height: 50px; background: #E0F4F4; color: #0E9B9B; font-size: 24px; display: flex; align-items: center; justify-content: center; border-radius: 8px; margin-bottom: 15px;"><i class="fa-light fa-battery-full"></i></div>
                                            <h4 style="color: #0F2044; font-size: 18px; font-weight: 700; margin-bottom: 10px;">UPS & DG Sets</h4>
                                            <p style="color: #4B5F70; font-size: 14px; line-height: 1.7; margin: 0;">Seamless backup power ensuring zero downtime in critical care environments.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div style="background: #fff; border: 1px solid #D5E5E5; padding: 25px; border-radius: 10px; margin-bottom: 20px; transition: all 0.3s; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%;">
                                            <div style="width: 50px; height: 50px; background: #E0F4F4; color: #0E9B9B; font-size: 24px; display: flex; align-items: center; justify-content: center; border-radius: 8px; margin-bottom: 15px;"><i class="fa-light fa-plug-circle-bolt"></i></div>
                                            <h4 style="color: #0F2044; font-size: 18px; font-weight: 700; margin-bottom: 10px;">OT/ICU Isolation Transformers</h4>
                                            <p style="color: #4B5F70; font-size: 14px; line-height: 1.7; margin: 0;">Patient-safe ungrounded power systems to prevent dangerous micro-shocks.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div style="background: #fff; border: 1px solid #D5E5E5; padding: 25px; border-radius: 10px; margin-bottom: 20px; transition: all 0.3s; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%;">
                                            <div style="width: 50px; height: 50px; background: #E0F4F4; color: #0E9B9B; font-size: 24px; display: flex; align-items: center; justify-content: center; border-radius: 8px; margin-bottom: 15px;"><i class="fa-light fa-walkie-talkie"></i></div>
                                            <h4 style="color: #0F2044; font-size: 18px; font-weight: 700; margin-bottom: 10px;">Nurse Call & ELV</h4>
                                            <p style="color: #4B5F70; font-size: 14px; line-height: 1.7; margin: 0;">Integrated low voltage systems for efficient patient care and security.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wow fadeInUp animated" data-wow-delay="0.3s" style="background: #F6FAFA; border-left: 5px solid #0E9B9B; padding: 30px; border-radius: 0 10px 10px 0; margin-bottom: 40px; box-shadow: 0 5px 20px rgba(0,0,0,0.04);">
                                    ...
                                    <p style="color: #4B5F70; margin: 0; line-height: 1.8; font-size: 15px;">
                                        Every electrical project we deliver comes with comprehensive documentation, as-built drawings, and operational manuals to ensure your facility seamlessly clears all NABH and ISO accreditations on the first attempt.
                                    </p>
                                </div>
                            </div>
                        </div>
